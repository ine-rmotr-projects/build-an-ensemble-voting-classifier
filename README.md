...
In this project you will be building a Voting classifier to aggregate the findings of different classifiers to predict the output class based on combined majority of voting for each output class.
